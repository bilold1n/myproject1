...
export default function footer() {
  return (
    <div>
      <div className="container bg-black flex items-center justify-center rounded-3xl px-[60px]">
        <h2 className="w-[550px] text-white text-4xl">
          STAY UPTO DATE ABOUT OUR LATEST OFFERS
        </h2>
        <div className="w-[500px] flex flex-col gap-5 py-[30px]">
          ...
          <button className="btn bg-white w-full rounded-full">
      ...
      <footer className="footer bg-base-200 text-base-content p-10">
        <div className="container footer">
          <div className="flex flex-col ">
            <h1 className="footer-title text-5xl">SHOP.CO</h1>
        ...
        {/* <div className="container mt-12">
              ...
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  <Link href={""}>
                    <img src="/humo.svg" alt="visa" />
                  </Link>
                  <Link href={""}>
                    <img src="/pay.svg" alt="visa" />
                  </Link>
                  <Link href={""}>
                    <img src="/apple.svg" alt="visa" />
                  </Link>
                  <Link href={""}>
                    <img src="/google.svg" alt="visa" />
                  </Link>
                </div>
              </div>
            </div> */}
